jQuery(document).ready(function() {
    "use strict";
    window.win_width = jQuery(window).width(), window.win_height = jQuery(window).height(), jQuery.parallax_func = function() {
        null == isMobile.any() && (jQuery("[data-background='parallax']").css("background-attachment", "fixed"), jQuery("[data-background='parallax']").each(function() {
            var a = jQuery(this);
            a.appear(function() {
                var b = a;
                b.parallax("50%", .1)
        ...
        jQuery("[data-animation]").each(function() {
            var a = jQuery(this);
            a.addClass("appear-animation"), jQuery(window).width() > 767 ? a.appear(function() {
            ...
            }, {accX: 0, accY: -150}) : a.addClass("appear-animation-visible")
        })
    }, jQuery.height_100 = function() {
        var a = 900;
        a >= win_height && jQuery("#slider .items").height(win_height), win_height > a && (jQuery("#slider .items").height(a), jQuery("#main-menu, #active-menu-sheild").height(win_height))
